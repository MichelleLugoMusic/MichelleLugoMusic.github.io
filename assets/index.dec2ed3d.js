var Y=Object.defineProperty,_=Object.defineProperties;var G=Object.getOwnPropertyDescriptors;var v=Object.getOwnPropertySymbols;var P=Object.prototype.hasOwnProperty,L=Object.prototype.propertyIsEnumerable;var j=(t,n,i)=>n in t?Y(t,n,{enumerable:!0,configurable:!0,writable:!0,value:i}):t[n]=i,m=(t,n)=>{for(var i in n||(n={}))P.call(n,i)&&j(t,i,n[i]);if(v)for(var i of v(n))L.call(n,i)&&j(t,i,n[i]);return t},p=(t,n)=>_(t,G(n));var B=(t,n)=>{var i={};for(var r in t)P.call(t,r)&&n.indexOf(r)<0&&(i[r]=t[r]);if(t!=null&&v)for(var r of v(t))n.indexOf(r)<0&&L.call(t,r)&&(i[r]=t[r]);return i};import{P as g,j as o,S as b,a as e,T as h,L as k,A as E,R as x,t as u,G as c,b as W,M as q,I as O,F as V,Y as N,c as K,d as J,e as M,f as Q,g as f,h as X,B as s,i as Z,k as F,H as ee,l as te,m as w,n as ne,o as ie,p as oe,C as le}from"./vendor.f4335e29.js";const re=function(){const n=document.createElement("link").relList;if(n&&n.supports&&n.supports("modulepreload"))return;for(const l of document.querySelectorAll('link[rel="modulepreload"]'))r(l);new MutationObserver(l=>{for(const a of l)if(a.type==="childList")for(const d of a.addedNodes)d.tagName==="LINK"&&d.rel==="modulepreload"&&r(d)}).observe(document,{childList:!0,subtree:!0});function i(l){const a={};return l.integrity&&(a.integrity=l.integrity),l.referrerpolicy&&(a.referrerPolicy=l.referrerpolicy),l.crossorigin==="use-credentials"?a.credentials="include":l.crossorigin==="anonymous"?a.credentials="omit":a.credentials="same-origin",a}function r(l){if(l.ep)return;l.ep=!0;const a=i(l);fetch(l.href,a)}};re();const T=r=>{var l=r,{icon:t,text:n}=l,i=B(l,["icon","text"]);return o(b,p(m({direction:"row",color:"white",alignItems:"center"},i),{children:[t,e(h,{style:{fontSize:"100%",lineHeight:"1vw",color:"white"},fontFamily:"Yaldevi",flexDirection:"row",children:n})]}))};T.propTypes={icon:g.element.isRequired,text:g.string.isRequired,width:g.string};const I=({icon:t,link:n,hoverColor:i})=>e(k,{href:n,children:e(E,{sx:{bgcolor:"common.grayLighter",marginRight:3,"&:hover":{bgcolor:i},transition:"all 0.2s ease-in-out"},children:t})});var U=`[contact]
location = "Boston, US"
...
`;const we={fontFamily:"Merienda",color:"white",fontSize:"6vw",lineHeight:"10vh"},$={fontWeight:"bold",fontSize:"1.8vw",lineHeight:"1rem",color:"white"},C={color:"white",fontSize:"1.1vw",letterSpacing:"0.1rem",wordSpacing:"0.04rem",lineHeight:"1.6rem",marginTop:"1.5%"},xe=()=>{const t=u.parse(ke);return o("div",{children:[o(c,{style:{backgroundImage:`url(${t.main.backgroundPic})`,backgroundBlendMode:"multiply",backgroundSize:"cover",backgroundPosition:"center",width:"100vw",height:"90vh",backgroundRepeat:"no-repeat",backgroundColor:"lightgray"},display:"flex",flexDirection:"column",children:[e(y,{}),e("div",{style:{width:"100%",flex:3,backgroundColor:"clear",display:"flex",alignItems:"center",justifyContent:"center",marginTop:"0%"}}),e("div",{style:{width:"100%",flex:1,display:"flex",alignItems:"flex-start",justifyContent:"center"},children:e("div",{style:we,children:t.main.title})})]}),e(c,{style:{backgroundSize:"auto 100%",backgroundPosition:"center",width:"100vw",height:"140vh",backgroundRepeat:"no-repeat"},sx:{backgroundColor:"common.dark_lavender"},display:"flex",flexDirection:"column",children:o(b,{direction:"column",sx:{marginTop:"8%",marginLeft:"8.5%",marginRight:"35%",alignItems:"left"},children:[e("div",{style:{display:"flex"}}),e(h,{component:"div",sx:{fontFamily:"Yaldevi",color:"white",marginBottom:"10%"},children:e(s,{sx:{fontWeight:"bold",fontSize:"3.5vw",lineHeight:"1rem",color:"white"},children:t.main.subtitle})}),o(h,{component:"div",sx:{fontFamily:"Yaldevi",color:"white"},children:[e(s,{sx:$,children:t.theAudioventure.title}),e(s,{sx:C,children:t.theAudioventure.body})]}),e("iframe",{title:"The Audioventure",src:t.theAudioventure.linkUrl,style:{width:"70vw",height:"50vh",borderStyle:"inset",borderWidth:"0.2vw",marginTop:"1.5%",marginBottom:"2%"}}),o("div",{style:{display:"flex",width:"70vw",height:"50vh",marginTop:"2%"},children:[e("div",{style:{display:"flex",width:"50%",height:"100%"},children:e(F,{url:t.soundcloud.playerUrl,config:{soundcloud:{options:{single_active:!1}}}})}),e("div",{style:{width:"50%",flex:1,margin:"auto"},children:e(D,{title:t.soundcloud.title,desc:t.soundcloud.body,linkUrl:t.soundcloud.linkUrl,linkText:t.soundcloud.linkText})})]}),t?t.games.map(n=>e(f,{children:e(A,{imgSrc:n.picUrl,title:n.title,desc:n.body,linkUrl:n.linkUrl,linkText:n.linkText})})):null,e("br",{})]})})]})},A=t=>{const{imgSrc:n,title:i,desc:r,linkUrl:l,linkText:a}=t;return o("div",{style:{display:"flex",width:"70vw",height:"50vh",marginTop:"5%"},children:[e("div",{style:{width:"70%",flex:1,objectFit:"contain",borderStyle:"inset",borderWidth:"0.2vw",boxSizing:"content-box",lineHeight:0,display:"block"},children:e("img",{style:{width:"100%",height:"100%",objectFit:"cover"},src:n})}),e("div",{style:{width:"50%",flex:1,margin:"auto"},children:e(D,{title:i,desc:r,linkUrl:l,linkText:a})})]})},D=t=>{const{title:n,desc:i,linkUrl:r,linkText:l}=t;return o(h,{component:"div",sx:{fontFamily:"Yaldevi",color:"white",flexWrap:"wrap",display:"flex"},children:[e(s,{sx:p(m({},$),{marginLeft:"10%"}),children:n}),e(s,{sx:p(m({},C),{marginLeft:"10%",marginTop:"4vh",width:"100%"}),children:i}),e(k,{href:r,sx:p(m({},C),{color:"black",marginLeft:"10%",":hover":{color:"white"},textDecoration:"none",marginTop:"4vh",width:"100%"}),children:l})," "]})};A.propTypes={imgSrc:g.string.isRequired,title:g.string.isRequired,desc:g.string.isRequired,linkUrl:g.string.isRequired,linkText:g.string.isRequired};var Me=`[main]
title = "Film Music"
backgroundPic = "https://michellelugomusic.github.io/MichelleLugoMusicResources/MusicMenusPic.jpeg"
`;const Te={fontFamily:"Merienda",color:"white",fontSize:"6vw",lineHeight:"10vh"},Ie=()=>{const t=u.parse(Me);return console.log(t),e("div",{children:o(c,{style:{backgroundImage:`url(${t.main.backgroundPic})`,backgroundBlendMode:"multiply",backgroundSize:"cover",backgroundPosition:"center",width:"100vw",height:"90vh",backgroundRepeat:"no-repeat",backgroundColor:"lightgray"},display:"flex",flexDirection:"column",children:[e(y,{}),e("div",{style:{width:"100%",flex:3,backgroundColor:"clear",display:"flex",alignItems:"center",justifyContent:"center",marginTop:"0%"}}),e("div",{style:{width:"100%",flex:1,display:"flex",alignItems:"flex-start",justifyContent:"center"},children:e("div",{style:Te,children:t.main.title})})]})})};function Se(){x.useEffect(()=>{document.title="Michelle Lugo Music",document.body.style.backgroundColor="#5E6687"});const t=u.parse(U);return e(ee,{children:o(te,{children:[e(w,{path:`/${t.navigate.home.subpage.trim()}`,element:e(z,{})}),e(w,{path:`/${t.navigate.biography.subpage.trim()}`,element:e(ge,{})}),t.navigate.portfolio.entries.map(n=>{const i=n.subpage.trim();switch(i){case"arrangements":var r=e(pe,{});break;case"musical_theater":var r=e(ve,{});break;case"video_games":var r=e(xe,{});break;case"film_music":var r=e(Ie,{});break;default:throw`Couldn't construct page for passed in page directory: ${n.subpage}`}return e(f,{children:e(w,{path:`/${i}`,element:r})})}),e(w,{path:"/",element:e(z,{})})]})})}const Re={lavender:"#5e6687aa",dark_lavender:"#5E6687",grayLighter:"rgba(255, 255, 255, 0.10)"},Ce=ne({palette:{common:Re}});ie.render(e(x.StrictMode,{children:o(oe,{theme:Ce,children:[e(le,{}),e(Se,{})]})}),document.getElementById("root"));
